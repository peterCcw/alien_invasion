...
class AlienInvasion:
    ...
    def _prepare_sounds(self):
        ...
        self.ship_fire_sound = pygame.mixer.Sound('sounds/blaster_player.wav')
        self.alien_fire_sound = pygame.mixer.Sound('sounds/blaster_alien.wav')
        self.alien_explosion_sound = pygame.mixer.Sound(
            'sounds/explosion_alien.wav')
        self.ship_explosion_sound = pygame.mixer.Sound(
            'sounds/explosion_ship.wav')
        self.cover_damage_sound = pygame.mixer.Sound('sounds/cover_damage.wav')
        self.end_of_game_sound = pygame.mixer.Sound('sounds/end_of_game.wav')
        self.level_up_sound = pygame.mixer.Sound('sounds/level_up.wav')

        self.ship_fire_sound.set_volume(0.3)
        self.alien_explosion_sound.set_volume(0.6)
